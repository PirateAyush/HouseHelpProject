    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.JSONField(blank=True, default=list, null=True)),
                ...
                ('adhar_card', models.ImageField(blank=True, null=True, upload_to='dashboard/users/documents/adhar')),
                ('voting_card', models.ImageField(blank=True, null=True, upload_to='dashboard/users/documents/voting')),
